...
public class game_15 extends AppCompatActivity {
    ...
    private void saveData(){
        myBase=new MyBase(game_15.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        setResult(game_15_2.REQUEST_CODE);
    }
    public void stats(){
        Intent intent=new Intent(this, game_15_2.class);
