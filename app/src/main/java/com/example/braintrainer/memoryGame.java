    ...
    private void checkEnd(){
        if(     iv_11.getVisibility()==View.INVISIBLE &&
            ...
            if(playerPoints>cpuPoints){
                Toast.makeText(memoryGame.this,"Player 1 Won!!!!!", Toast.LENGTH_SHORT).show();
            }
            else if(playerPoints<cpuPoints){
                Toast.makeText(memoryGame.this,"Player 2 Won!!!!!", Toast.LENGTH_SHORT).show();
            }
            else {
                Toast.makeText(memoryGame.this,"Tied", Toast.LENGTH_SHORT).show();
            }
            AlertDialog.Builder alertDialogueBuilder=new AlertDialog.Builder(memoryGame.this);
